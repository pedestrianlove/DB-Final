...
@section('content')
    <form action="#" method="post">
        ...
        <div class="entry-wrapper">
            ...
            <input class="entry-input" type="text" name="Employee_ID" value="{{old ('Employee_ID')}}">
            @error('Employee_ID')
            <p class="error-format">{{ $message }}</p>
            @enderror
            <label class="entry-text">員工姓名:</label>
            <input class="entry-input" type="text" name="Employee_Name" value=" " disabled="disabled"><br>


            <label class="entry-text">派駐國家代碼:</label>
            <input class="entry-input" type="text" name="Nation_Code" value="{{old('Nation_Code')}}"><br>
            @error('Nation_Code')
            <p class="error-format">{{ $message }}</p>
            @enderror
            <label class="entry-text">派駐國家名稱:</label>
            <input class="entry-input" type="text" name="Nation_Code" value=" " disabled="disabled"><br>
